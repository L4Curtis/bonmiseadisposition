 ...
 *  (entre les mains du collaborateur). */
...
/** Équipement « prêté » : ni rendu ni déclaré non rendu, sur un bon dont le
 *  statut ∈ LOANED_BON_STATUSES (+ filtre filiale optionnel). */
...
/** Équivalent SQL de `buildLoanedEquipmentWhere`, sur les alias `be`
