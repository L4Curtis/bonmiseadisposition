...
export const ACTION_LABELS: Record<string, { label: string; color: string }> = {
  ...
  bon_closed_unilateral:       { label: 'Clôture sans signature',   color: VIGILANCE },
  ...
  declare_not_returned:        { label: 'Équipements non restitués', color: VIGILANCE },
  declare_not_returned_partial:{ label: 'Non restitué (partiel)',   color: VIGILANCE },
  mark_found:                  { label: 'Équipement retrouvé',      color: REUSSITE },
  ...
  signed_pv_cloture:           { label: 'Signé — PV de non-restitution', color: REUSSITE },
  signed_it_cachet:            { label: 'Signature IT',             color: MUTED },
  // Pièces jointes
