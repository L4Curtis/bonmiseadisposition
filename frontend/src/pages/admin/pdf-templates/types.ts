...
export const SECTIONS: { key: string; label: string; icon: SectionIcon; fields: FieldDef[] }[] = [
  {
    ...
    fields: [
      ...
      { key: 'headerBg', label: 'En-tête tableau', type: 'color' },
      { key: 'rowAlt', label: 'Ligne alternée', type: 'color' },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: 'tableHeaderSize', label: 'En-tête tableau', type: 'number', min: 5, max: 24 },
  ...
  {
    key: 'header', label: 'En-tête du document', icon: LayoutTemplate,
    fields: [
      ...
      { key: 'showReference', label: 'Afficher la référence', type: 'boolean' },
      { key: 'showDates', label: 'Afficher les dates', type: 'boolean' },
    ],
  },
  {
    key: 'infoBoxes', label: 'Encadrés d\'information', icon: LayoutTemplate,
    fields: [
      { key: 'showCollaborateur', label: 'Afficher collaborateur', type: 'boolean' },
      { key: 'showEntite', label: 'Afficher entité', type: 'boolean' },
      { key: 'collaborateurTitle', label: 'Titre encadré collaborateur', type: 'text' },
      { key: 'entiteTitle', label: 'Titre encadré entité', type: 'text' },
    ],
  },
  {
    key: 'table', label: 'Tableau des équipements', icon: LayoutTemplate,
    fields: [
      { key: 'sectionTitle', label: 'Titre de section', type: 'text' },
      { key: 'showRowNumbers', label: 'Numéros de ligne', type: 'boolean' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'itMention', label: 'Mention légale IT', type: 'text' },
      { key: 'collabTitle', label: 'Titre collaborateur', type: 'text' },
      { key: 'collabMention', label: 'Mention légale collaborateur', type: 'text' },
    ],
  },
  {
