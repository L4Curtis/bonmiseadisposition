  ...
  return (
    <div className="border border-border rounded-lg divide-y divide-border overflow-hidden">
      {templates.map((tpl) => (
        ...
        >
          {/* Color dot */}
          <div className={`h-3 w-3 rounded-full shrink-0 ${CATEGORY_COLORS[tpl.category] ?? 'bg-muted-foreground/40'}`} />
          ...
          <div className="flex items-center gap-1 shrink-0">
            <Button variant="ghost" size="sm" onClick={() => onPreview(tpl)} title="Apercu">
            ...
            {tpl.isCustomized && (
              <Button variant="ghost" size="sm" onClick={() => onReset(tpl)} title="Reinitialiser">
